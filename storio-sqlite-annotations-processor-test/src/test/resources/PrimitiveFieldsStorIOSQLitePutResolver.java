...
public class PrimitiveFieldsStorIOSQLitePutResolver extends DefaultPutResolver<PrimitiveFields> {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForInsertQuery(@NonNull PrimitiveFields object) {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForUpdateQuery(@NonNull PrimitiveFields object) {
        ContentValues contentValues = new ContentValues(8);
