...
public class BoxedTypesMethodsConstructorIgnoreNullStorIOSQLitePutResolver extends DefaultPutResolver<BoxedTypesMethodsConstructorIgnoreNull> {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForInsertQuery(@NonNull BoxedTypesMethodsConstructorIgnoreNull object) {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForUpdateQuery(@NonNull BoxedTypesMethodsConstructorIgnoreNull object) {
        ContentValues contentValues = new ContentValues(6);
