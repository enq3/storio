...
public class BoxedTypesMethodsConstructorStorIOSQLitePutResolver extends DefaultPutResolver<BoxedTypesMethodsConstructor> {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForInsertQuery(@NonNull BoxedTypesMethodsConstructor object) {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForUpdateQuery(@NonNull BoxedTypesMethodsConstructor object) {
        ContentValues contentValues = new ContentValues(6);
