...
public class PrimitiveMethodsConstructorStorIOSQLitePutResolver extends DefaultPutResolver<PrimitiveMethodsConstructor> {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForInsertQuery(@NonNull PrimitiveMethodsConstructor object) {
    ...
    @Override
    @NonNull
    public ContentValues mapToContentValuesForUpdateQuery(@NonNull PrimitiveMethodsConstructor object) {
        ContentValues contentValues = new ContentValues(8);
